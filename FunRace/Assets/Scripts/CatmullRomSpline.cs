...
public class CatmullRomSpline : MonoBehaviour
{
    ...
    public Vector3 GetCurvePos(float curveT, int i)
    {
        if ((i == 0 || i == controlPointsList.Length - 2 || i == controlPointsList.Length - 1) && !isLooping)
        {
            return Vector3.zero;
        ...
        return GetCatmullRomPosition(curveT, p0, p1, p2, p3);
    }

    public Vector3 GetCurveForward(float curveT, int i)
    {
        if ((i == 0 || i == controlPointsList.Length - 2 || i == controlPointsList.Length - 1) && !isLooping)
        {
            return Vector3.zero;
        ...
        Vector3 f1 = controlPointsList[i].forward;
        Vector3 f2 = controlPointsList[ClampListPos(i + 1)].forward;

        return Vector3.Lerp(f1, f2, curveT);
    }
}